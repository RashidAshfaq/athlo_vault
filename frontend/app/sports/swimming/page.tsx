...
// Mock data for swimming athletes
const swimmingAthletes = [
  ...
  },
  {
    ...
    growth: "+26%",
    followers: "74K",
    stats: { pb100m: "52.34", pb200m: "1:56.78", medals: 6 },
    verified: true,
    trending: true,
  },
  {
    ...
    growth: "+22%",
    followers: "69K",
    stats: { pb100m: "59.45", pb200m: "2:08.12", medals: 7 },
    verified: true,
    trending: false,
  },
]
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <div className="flex items-center justify-center space-x-2 mb-4">
                ...
                <h1 className="text-4xl sm:text-5xl font-bold text-white">Swimming Athletes</h1>
              </div>
              <p className="text-xl text-slate-300 max-w-2xl mx-auto">
                Dive into investments with Olympic-bound swimmers and record holders
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
              <div className="flex flex-col sm:flex-row gap-4 flex-1">
                <div className="relative flex-1 max-w-md">
                  ...
                  <Input placeholder="Search swimmers..." className="pl-10 bg-slate-900 border-slate-700 text-white" />
                </div>
                <Select>
                  ...
                  <SelectContent className="bg-slate-800 border-slate-700">
                    ...
                    <SelectItem value="medley">Individual Medley</SelectItem>
                  </SelectContent>
                </Select>
                <Select>
                  <SelectTrigger className="w-full sm:w-48 bg-slate-900 border-slate-700 text-white">
